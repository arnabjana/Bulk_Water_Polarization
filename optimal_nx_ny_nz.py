...
mu_raw_data = np.load('mu_raw_water_1000.npy')
pmax_data = np.load('pmax_water_1000.npy')
pbar_data = np.load('scaled_pbar_water_1000.npy')
...
np.save('punwrap_water_1000.npy', updated_punwrap)
